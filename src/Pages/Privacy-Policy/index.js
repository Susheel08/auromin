...
const Privacy = () => {
  return (
    <div className="flex flex-col justify-center items-center border-y pt-16 pb-24">
      <p className="text-2xl pb-10">Privacy Policy</p>
      ...
      <div className="flex flex-col text-lg justify-center items-start gap-3 lg:w-[55%] md:[50%] w-[85%]">
        ...
        <div>
          <p className="font-bold pt-5">Personal information we collect</p>
          <p>
        ...
        <div>
          <p className="font-bold pt-5">Sharing you personal Information</p>
          <p>
        ...
        <div>
          <p className="font-bold pt-5"> Behavioural advertising</p>
          <p>
        ...
        <div>
          <p className="font-bold pt-5">Do not track</p>
          <p>
        ...
        <div>
          <p className="font-bold pt-5">Your rights</p>
          <p>
        ...
        <div>
          <p className="font-bold pt-5">Data retention</p>
          <p>
        ...
        <div>
          <p className="font-bold pt-5">Changes</p>
          <p>
        ...
        <div>
          <p className="font-bold pt-5">Minors</p>
          <p>The Site is not intended for individuals under the age of 16 .</p>
        </div>
        <div>
          <p className="font-bold pt-5">Contact us</p>
          <p>
            For more information about our privacy practices, if you have
            questions, or if you would like to make a complaint, please contact
            us by e‑mail at support@auromin.in or by mail using the details
            provided below:
          </p>
        </div>
      </div>
