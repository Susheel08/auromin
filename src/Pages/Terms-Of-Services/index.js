...
const Terms = () => {
  return (
    <div className="flex flex-col justify-center items-center border-y pt-16 pb-24">
      <p className="text-2xl pb-10">Terms of Services</p>

      <div className="flex flex-col text-lg justify-center items-start gap-3 lg:w-[55%] md:[50%] w-[85%]">
        <div>
          <p className="font-bold">OVERVIEW</p>
          <p className="pb-5">
            This website is operated by Auromin. Throughout the site, the terms
            “we”, “us” and “our” refer to Auromin. Auromin offers this website,
        ...
        <div>
          <p className="font-bold pt-5 ">SECTION 1 - ONLINE STORE TERMS</p>
          <p>
        ...
        <div>
          <p className="font-bold pt-5 ">SECTION 2 - GENERAL CONDITIONS</p>
          <p>
        ...
        {/* 4 */}
        <div>
          <p className="font-bold pt-5">SECTION 7 - OPTIONAL TOOLS</p>
          <p>
        ...
        {/* 5 */}
        <div>
          <p className="font-bold pt-5">SECTION 8 - THIRD-PARTY LINKS</p>
          <p>
        ...
        {/* 7 */}
        <div>
          <p className="font-bold pt-5">SECTION 10 - PERSONAL INFORMATION</p>
          <p>
        ...
        {/* 9 */}
        <div>
          <p className="font-bold pt-5">SECTION 12 - PROHIBITED USES</p>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            <br />
            In no case shall Auromin, our directors, officers, employees,
        ...
        {/* 11 */}
        <div>
          <p className="font-bold pt-5">SECTION 14 - INDEMNIFICATION</p>
          <p>
            You agree to indemnify, defend and hold harmless Auromin and our
        ...
        {/* 12 */}
        <div>
          <p className="font-bold pt-5">SECTION 15 - SEVERABILITY</p>
          <p>
        ...
        {/* 13 */}
        <div>
          <p className="font-bold pt-5">SECTION 16 - TERMINATION</p>
          <p>
        ...
        {/* 14 */}
        <div>
          <p className="font-bold pt-5">SECTION 17 - ENTIRE AGREEMENT</p>
          <p>
        ...
        {/* 15 */}
        <div>
          <p className="font-bold pt-5">SECTION 18 - GOVERNING LAW</p>
          <p>
        ...
        {/* 17 */}
        <div>
          <p className="font-bold pt-5">SECTION 20 - CONTACT INFORMATION</p>
          <p>
